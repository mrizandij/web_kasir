...
echo "<tr style='background-color:#ccc;'>
    ...
    <td width='10%' align='center'>Pembeli</td>
...
echo "<tr><td colspan='10'><b>Tahun: $bulan</b></td> <td style='text-align:right;'><b>Total:</b></td><td style='text-align:right;'><b>".'Rp '.number_format($tots)."</b></td></tr>";
        ?>
</table>
